...
ensemble_model_path = r'C:\Users\Shree\SML_DL_PROJECT\SML_DL_PROJECT\Models\ensemble_model.joblib'
...
if __name__ == "__main__":
    ...
    train_data = datagen.flow_from_directory(
        r'C:\Users\Shree\SML_DL_PROJECT\SML_DL_PROJECT\Dataset\Dataset\train',
    ...
    test_data = datagen.flow_from_directory(
        r'C:\Users\Shree\SML_DL_PROJECT\SML_DL_PROJECT\Dataset\Dataset\test',
        target_size=IMAGE_SIZE,
        batch_size=BATCH_SIZE,
        class_mode='binary',
        shuffle=False
